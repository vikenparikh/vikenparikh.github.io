---
title: About Me
photo: '@assets/about/viken-profile-photo.jpeg'
link: https://linkedin.com/in/vikenparikh96/
---
...
AI Platform Engineering, LLM Agent Systems, MLOps, Generative AI, Backend Engineering, Distributed Systems, Cloud Security, Payments Infrastructure, API Design & Development, DevOps & Automation, Data Engineering, Product Prototyping, Technical Leadership

## AI Specialties

LLM Agents, RAG (Retrieval-Augmented Generation), Multi-Agent Orchestration (LangGraph, MCP), Fine-Tuning (LoRA, DPO, RLHF), Prompt Engineering, Model Evaluation (LLM-as-judge, golden sets), AI Safety & Guardrails, Inference Optimization (vLLM, Triton), MLOps (MLflow, Ray, SageMaker), Feature Engineering, A/B Testing, NLP, Computer Vision, Reinforcement Learning, AI Product Strategy
