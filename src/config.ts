...
export const siteConfig: SiteConfig = {
  ...
  skillAreas: [
    ...
    },
    {
      ...
      items: [
        "AWS (SageMaker, Bedrock, ECS, EKS, Lambda, S3, DynamoDB, Step Functions)",
    ...
    },
    {
      title: "AI / ML",
      items: [
        "LLMs (GPT-4/5, Claude, Llama, Mistral, Gemini)",
        "RAG (vector search, hybrid retrieval, rerankers)",
        "LLM Agents (tool use, planning, multi-agent orchestration)",
        "Agent frameworks (LangChain, LangGraph, Crew AI, AutoGen, MCP)",
        "Fine-tuning (LoRA, QLoRA, PEFT, SFT, RLHF, DPO)",
        "Embeddings & Vector DBs (pgvector, Pinecone, Weaviate, Qdrant, FAISS, Chroma)",
        "Reinforcement Learning (PPO, DPO, RLAIF)",
        "NLP (entity extraction, summarization, semantic search, classification)",
        "Computer Vision (YOLO, detection, segmentation, OCR, multimodal)",
        "Speech (Whisper, TTS)",
        "Prompt engineering, structured outputs, function calling, JSON-mode",
        "Evaluation (LLM-as-judge, eval harnesses, golden sets, A/B + offline metrics)",
        "Guardrails & safety (red-teaming, jailbreak defense, PII redaction)",
        "Knowledge graphs",
    ...
    },
    {
      ...
      items: [
        ...
        "Training orchestration (Ray, Kubeflow, Airflow)",
        "Model serving (Triton, BentoML, vLLM, TGI)",
        "Observability for AI (LangSmith, Langfuse, OpenTelemetry, Arize, Helicone)",
        "Data pipelines (Spark, dbt, Pandas, Polars)",
        "Streaming (Kafka, Kinesis)",
        "Data versioning (DVC, LakeFS)",
        "GPU infra (CUDA, accelerate, distributed training)",
      ],
    },
    {
      title: "Databases",
  ...
  experience: [
    {
      ...
      bullets: [
        "Building EA's AI platform: design and ship core machine-learning and AI solutions, agent frameworks, and skill primitives that internal teams compose into game and live-service experiences.",
        "Engineering platform services for the ML lifecycle end-to-end — Python ML stacks, MLOps (training, eval, model registry, monitoring), feature pipelines, and inference serving on AWS (SageMaker, ECS/EKS, Lambda, S3) — with reliability, cost, and latency SLOs.",
        "Driving AI adoption across EA studios and teams: partnering on use-case discovery, RAG / LLM-agent / fine-tuning patterns, prompt + tool-use evals, and internal enablement so AI capabilities ship safely and measurably.",
      ],
    },
    {
